...
SECRETS=(
  ...
  "hnfm-tls:hnfm"
  "n8n-tls:n8n"
  "langfuse-tls:observability"
  "openobserve-tls:observability"
  "jaeger-tls:observability"
  "parseable-tls:observability"
  "signoz-tls:observability"
  "uptrace-tls:observability"
  "tempo-tls:observability"
  "lgtm-tls:observability"
)
